...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        // ✅ Separar manualmente para evitar desfase UTC
        const [year, mes, dia] = e.target.value.split('-').map(Number);
        const fecha = new Date(year, mes - 1, dia);
        const diaSemana = fecha.getDay(); // getDay() en hora local, no getUTCDay()
